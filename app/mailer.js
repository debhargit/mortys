// ============================================================================
//  Meltha Honda — Email sender (Nodemailer wrapper)
//
//  Configure via .env:
...
//    SMTP_FROM="Meltha Honda <noreply@melthahonda.com>"
//
...
async function sendEmail({ to, subject, html, text }) {
  ...
  const from = process.env.SMTP_FROM || 'Meltha Honda <noreply@melthahonda.com>';
  if (!active) {
    ...
    <tr><td align="center">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,.08);max-width:560px;width:100%">
        ...
        <tr><td style="padding:16px 24px;background:#0b1b2b;color:#94a3b8;font-size:12px;line-height:1.5">
          127 Hagley Park Avenue, Kingston · +1 876-758-8503<br/>
          <a href="https://melthahonda.miamimistress.com" style="color:#ffb703;text-decoration:none">melthahonda.miamimistress.com</a>
        </td></tr>
      </table>
    </td></tr>
  </table></body></html>`;
...
function welcomeEmail({ name, email }) {
  ...
  return {
    ...
    html: shell('Welcome', `
      ...
      <p><a href="https://melthahonda.miamimistress.com" style="display:inline-block;background:#d62828;color:#fff;padding:10px 18px;border-radius:8px;text-decoration:none;font-weight:700">Browse inventory</a></p>
...
function backInStockEmail({ product_name, product_img, price_usd }) {
  ...
  return {
    ...
    html: shell('Back in stock', `
      ...
      <p><a href="https://melthahonda.miamimistress.com#parts" style="display:inline-block;background:#d62828;color:#fff;padding:10px 18px;border-radius:8px;text-decoration:none;font-weight:700">Shop now</a></p>
