...
const ROUTE_MODS = ['auth', 'storefront', 'admin', 'pos', 'pos_txn', 'inventory', 'media', 'crm', 'cron', 'customer', 'shipping', 'payments', 'admin_crm', 'admin_users', 'service', 'ops', 'reports', 'admin_misc'];
let fails = 0;
